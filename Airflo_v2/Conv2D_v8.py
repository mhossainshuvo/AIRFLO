...
model_cnn = Sequential([
    Conv2D(filters=32, kernel_size=(2, 1), activation='relu', input_shape=(num_features, 1, 1)),
    BatchNormalization(),
    MaxPooling2D(pool_size=(2, 1)),
    Dropout(0.1),
    
    Conv2D(filters=64, kernel_size=(2, 1), activation='relu'),
    BatchNormalization(),
    MaxPooling2D(pool_size=(2, 1)),
    Dropout(0.1),
...
# Early stopping
monitor = EarlyStopping(monitor='val_loss', min_delta=1e-4, patience=50, 
